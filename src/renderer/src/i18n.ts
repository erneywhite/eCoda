...
const RU: Strings = {
  ...
  'settings.eq.title': 'Эквалайзер',
  'settings.eq.on': 'Включён',
  'settings.eq.off': 'Выключен',
  'settings.eq.hint':
    'Десятиполосный эквалайзер для всего приложения. Выбери готовый пресет или подвигай ползунки вручную (±12 дБ на полосу). Применяется ко всему звуку сразу.',
  'eq.preset.flat': 'Ровно',
  'eq.preset.bass': 'Бас',
  'eq.preset.treble': 'Высокие',
  'eq.preset.vocal': 'Вокал',
  'eq.preset.rock': 'Рок',
  'eq.preset.pop': 'Поп',
  'eq.preset.electronic': 'Электроника',
  'eq.preset.jazz': 'Джаз',
  'eq.preset.classical': 'Классика',
  'eq.preset.hiphop': 'Хип-хоп',
  'eq.preset.custom': 'Своё',
...
const EN: Strings = {
  ...
  'settings.eq.off': 'Off',
  'settings.eq.hint':
    'Ten-band equalizer for the whole app. Pick a preset or drag the sliders by hand (±12 dB per band). Applies to all audio at once.',
  'eq.preset.flat': 'Flat',
  'eq.preset.bass': 'Bass',
  'eq.preset.treble': 'Treble',
